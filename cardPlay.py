...
class CardPlay(BoxLayout):
    def __init__(self, **kwargs):
        ...
        header.add_widget(Button(text='Blablabla', color=(0,0,0,1), font_name='Jersey10', font_size=35, halign='center', valign='center', background_color=(0,0,0,0)))
        header.text_size=header.size
        self.add_widget(header)

        score = BoxLayout(orientation='horizontal',size_hint=(.2, .05), pos_hint={'center_x':.5})
        score.add_widget(Label(text='3', color=(0,0,1,1), font_name='Jersey10', font_size=30, halign='center', valign='center'))
        score.add_widget(Label(text='1', color=(1,0,0,1), font_name='Jersey10', font_size=30, halign='center', valign='center'))
        score.add_widget(Label(text='2', color=(0,1,0,1), font_name='Jersey10', font_size=30, halign='center', valign='center'))
        ...
        card.label = Label(text='Kenapa kita hidup sih oay', color=(0,0,0,1), font_name='Inconsolata', font_size=28, halign='center', valign='center', size_hint=(1, .2))
        ...
        rate.add_widget(Button(text='Easy', color=(0,0,1,1), font_name='Inconsolata', font_size=20, halign='center', valign='center', background_color=(0,0,0,0)))
        ...
        tab = Label(text='Next', font_name='Jersey10', font_size=25, size_hint=(1, .15), color=(1,1,1,1))
    ...
    def showEndPlay(instance):
        card = instance.main.layout.card
